      ...
      <div className="max-w-7xl mx-auto">
        <div className="text-center mb-12 md:mb-16">
          ...
          <p className="text-lg md:text-xl font-lato-medium text-text-secondary dark:text-text-secondary max-w-2xl mx-auto">
            ...
            backend logic and visual design. Always learning, always creating.
          </p>
        </div>
        ...
        <div className="flex flex-col lg:flex-row items-center justify-center gap-12 md:gap-24 lg:gap-32 mt-12 md:mt-16">
          ...
          <div className="w-full lg:w-[630px] max-w-full" data-aos="fade-left">
            <div className="text-base md:text-lg leading-relaxed text-text-secondary dark:text-text-secondary font-lato-medium space-y-4">
              <p>
                I'm <strong className="text-text-primary dark:text-text-primary">Kevin Santiago Gutiérrez Amorocho</strong>, a Software Development Technician with practical training at
                <strong className="text-text-primary dark:text-text-primary"> SENA</strong>
                and currently undergoing intensive training at <strong className="text-text-primary dark:text-text-primary">CampusLands</strong>.
                I have hands-on experience in building responsive and dynamic web applications using
                <strong className="text-text-primary dark:text-text-primary"> HTML, CSS, JavaScript</strong>, and API consumption.
                I work with modular structures (separate HTML, CSS, JS, PHP), version control with <strong className="text-text-primary dark:text-text-primary">Git & GitHub</strong>,
                and I also have knowledge in backend development with <strong className="text-text-primary dark:text-text-primary">Python</strong> (servers, routing, business logic).
              </p>
              <p>
                Additionally, I have experience with <strong className="text-text-primary dark:text-text-primary">React Native</strong> (Basic), <strong className="text-text-primary dark:text-text-primary">Tailwind CSS</strong> (Intermediate), <strong className="text-text-primary dark:text-text-primary">Bootstrap</strong> (Intermediate), <strong className="text-text-primary dark:text-text-primary">Vue.js</strong> (Basic),
                with modern frontend practices, and task automation.
                I am recognized for being a <strong className="text-text-primary dark:text-text-primary">self-taught learner</strong>, with strong problem-solving skills, analytical
                thinking, and a continuous drive to grow as a <strong className="text-text-primary dark:text-text-primary">junior full stack developer</strong>.
              </p>
            </div>
            <a
              href={cvPdf}
